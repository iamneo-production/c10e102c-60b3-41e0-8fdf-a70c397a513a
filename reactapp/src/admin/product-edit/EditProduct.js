...
class EditProduct extends Component{
  ...
  getProductDetails = () => {
    axios.get(`https://8080-abdedcaacccedacedeebaccebadfdbfcfccadbaecfcbc.examlyiopb.examly.io/admin/productEdit/${this.state.id}`).then((res) => {
      ...
      document.querySelector("#dressPrice").value = this.state.rendered.price;
      document.querySelector("#dressQuantity").value = this.state.rendered.quantity;
    })
  }
      ...
      <div id="addDressBody">
        <form>
          <div className="addproduct-form" id="signupBox">
              ...
              <div className="field">
                  <p className="control has-icons-left ">
                      <input required className="input" type="text" placeholder="Product Price" id="dressPrice" onChange={this.changePrice} />
                      <span className="icon is-small is-left" >
              ...
              <div className="field">
                  <p className="control">
                  <textarea className="textarea has-fixed-size" placeholder="Product Description" id="dressDescription" rows="2" onChange={this.changeDescription}></textarea>
                  </p>
              </div>
              <div className="field">
                  <p className="control has-icons-left">
                      <input required className="input" type="text" placeholder="Image Url" id="dressImageUrl" onChange={this.changeUrl} />
                      <span className="icon is-small is-left">
              ...
              <div className="field">
                  <p className="control has-icons-left">
                      <input required className="input" type="text" placeholder="Product Quantity" id="dressQuantity" onChange={this.changeQuantity} />
                      <span className="icon is-small is-left">
              ...
              <div className="field is-grouped">
                  <p className="control">
                      <button className="button is-warning" id="addDressButton" onClick={this.saveProductDetails}>
                      Save
                      </button>
                  </p>
                  <p className="control">
