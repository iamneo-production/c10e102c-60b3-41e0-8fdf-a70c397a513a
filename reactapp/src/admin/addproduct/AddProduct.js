  ...
  render(){
    return(
      ...
      <div id="addDressBody" data-testid="addDressBody">
        <form>
          <div className="addproduct-form" id="signupBox" data-testid="signupBox">
              <h1 className="title text is-warning">Add Product</h1>
              <div className="field">
                  <p className="control has-icons-left ">
                      <input required className="input" type="text" placeholder="Product Id" id="dressId" data-testid="dressId" onChange={this.changeId}/>
              ...
              <div className="field is-grouped">
                  <p className="control">
                      <button className="button is-warning" id="addDressButton" daat-testid="addDressButton" onClick={this.addProductAdmin}>
                      Add
                      </button>
                  </p>
                  <p className="control">
                    <Link to="/admin">
                      <button className="button is-danger" id="cancelButton" data-testid="cancelButton">
                      Cancel
                      </button>
                    </Link>
                  </p>
